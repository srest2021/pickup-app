...
values 
  ...
  ('00000000-0000-0000-0000-000000000000','473dc833-4e44-4f22-bdc9-3b13c9253d2a','authenticated','authenticated','user3@example.com','$2a$10$YknGCPK8YAZkqgjlU8JVCO5.qbJx7mjTOdk62w7WEu42DGlgQwBMa',now(),null,'',now(),'',null,'','',null,now(),'{"provider":"email","providers":["email"]}','{"username":"username3"}',null,now(),now(),null,null,'','',null,'',0,null,'',null,false,null);
...
values
  ...
  (uuid_generate_v4(),'473dc833-4e44-4f22-bdc9-3b13c9253d2a','473dc833-4e44-4f22-bdc9-3b13c9253d2a','{"sub":"473dc833-4e44-4f22-bdc9-3b13c9253d2a","email":"user3@example.com","email_verified":false,"phone_verified":false}','email',now(),now());
...
WHERE id = '473dc833-4e44-4f22-bdc9-3b13c9253d2a';
